export default[
  ...
  "event PurchaseFoodChakra(uint256 chakraUuid, uint256 amountOfFood, uint256 availableFood, address chakraOwner, uint256 pcuyReceived, uint256 pcuyTaxed, uint256 tax)",
  "event PurchaseLand(address _account, uint256 uuid, uint256 landPrice, uint256 _location, address poolRewardsAddress)",
  "event PurchasePachaPass(address account, uint256 pachaUuid, uint256 pachaPassUuid, uint256 price, uint256 pcuyReceived, uint256 pcuyTaxed)",
