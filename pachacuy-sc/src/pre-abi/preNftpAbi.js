module.exports = [
  ...
  },
  {
    ...
    name: "_nftInfo",
    outputs: [
      { internalType: "bytes32", name: "nftType", type: "bytes32" },
      { internalType: "bool", name: "canTransfer", type: "bool" },
      { internalType: "address", name: "scAddress", type: "address" },
      { internalType: "bool", name: "requiredRole", type: "bool" },
      { internalType: "string", name: "errorMessage", type: "string" },
      { internalType: "string", name: "errorRegister", type: "string" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "bytes[]", name: "_dataArray", type: "bytes[]" }],
    name: "fillNftsInfo",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    ...
    name: "mint",
    outputs: [{ internalType: "uint256", name: "uuid", type: "uint256" }],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
